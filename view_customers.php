    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li class="active"><!-- active begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View DS
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> 
                                      ...
                                      <a href="index.php?details_customer=<?php echo $c_id; ?>">
                                ...
                                <td> 
                                      ...
                                      <a href="print2.php?print=<?php echo $c_id; ?>">
                                     
                                        <i class="btn btn-primary">print</i>
