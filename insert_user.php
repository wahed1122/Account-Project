               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                  ...
                  <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="admin_role" class="form-control"><!-- form-control Begin -->
                              
                              <option selected disabled> Select a  Role </option>
                              
                              <?php 
                              
                              $get_p_cats = "SELECT * FROM `role`";
                              $run_p_cats = mysqli_query($con,$get_p_cats);
                              
                              while ($row_p_cats=mysqli_fetch_array($run_p_cats)){
                                  
                                  $role_id = $row_p_cats['role_id'];
                                  $role_name = $row_p_cats['role_name'];
...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_country,admin_contact,admin_job,admin_image,admin_about,Role) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_job','$user_image','$user_about','$admin_role')";
